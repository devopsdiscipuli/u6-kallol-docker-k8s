...
added 1518 packages, and audited 1519 packages in 2m

274 packages are looking for funding
  run `npm fund` for details

55 vulnerabilities (2 moderate, 53 high)
...
-rw-r--r-- 1 itzamna 197121      0 Feb 23 22:43 1.sh
...
$ ll -a
total 1042
drwxr-xr-x 1 itzamna 197121      0 Feb 23 22:56 ./
